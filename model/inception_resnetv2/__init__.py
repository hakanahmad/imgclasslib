...
def create_inception_resnetv2(IMG_SIZE,num_categories=4):
    ...
    x2 = Conv2D(kernel_size=1,strides=1,filters=320,padding='same')(x)
    x = Add()([x1,x2])
    x = ReLU()(x)
    x1 = Inception1b(x,[1,(1,3),(1,3,3)],[1,(1,1),(1,1,1)],[32,(32,32),(32,48,64)])
    x2 = Conv2D(kernel_size=1,strides=1,filters=320,padding='same')(x)
    ...
    x2 = Conv2D(kernel_size=1,strides=1,filters=1088,padding='same')(x)
    x = Add()([x1,x2])
    x = ReLU()(x)
    x1 = Inception2b(x,[1,(1,(1,7),(7,1))],[1,(1,1,1)],[192,(128,160,192)])
    x2 = Conv2D(kernel_size=1,strides=1,filters=1088,padding='same')(x)
    ...
    x2 = Conv2D(kernel_size=1,strides=1,filters=2080,padding='same')(x)
    x = Add()([x,x1])
    x = ReLU()(x)
    x1 = Inception2b(x,[1,(1,(1,3),(3,1))],[1,(1,1,1)],[192,(192,224,256)])
    x2 = Conv2D(kernel_size=1,strides=1,filters=2080,padding='same')(x)
