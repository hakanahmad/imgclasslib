...
def create_inception_resnetv2(IMG_SIZE,num_categories=4):
    ...
    #inception2b
    x = Inception2b(x,[1,(1,(1,7),(7,1))],[1,(1,1,1)],[192,(128,160,192)])
    x1 = Conv2D(kernel_size=1,strides=1,filters=1088,padding='same')(x)
    x = Add()([x,x1])
    x = ReLU()(x)
    x = Inception2b(x,[1,(1,(1,7),(7,1))],[1,(1,1,1)],[192,(128,160,192)])
    x1 = Conv2D(kernel_size=1,strides=1,filters=1088,padding='same')(x)
    ...
    #inception2b
    x = Inception2b(x,[1,(1,(1,3),(3,1))],[1,(1,1,1)],[192,(192,224,256)])
    x1 = Conv2D(kernel_size=1,strides=1,filters=2080,padding='same')(x)
    x = Add()([x,x1])
    x = ReLU()(x)
    x = Inception2b(x,[1,(1,(1,3),(3,1))],[1,(1,1,1)],[192,(192,224,256)])
    x1 = Conv2D(kernel_size=1,strides=1,filters=2080,padding='same')(x)
