...
def conv_block(layer,kernel_array,stride_array,filter_array):
    ...
    x1 = ReLU()(x1)
    x1 = Conv2D(kernel_size=kernel_array[0],strides=stride_array[0],filters=filter_array[0],padding='same')(x1)
    x1 = BatchNormalization()(x1)
    x1 = ReLU()(x1)
    x1 = Conv2D(kernel_size=kernel_array[1],strides=stride_array[1],filters=filter_array[1],padding='same')(x1)
